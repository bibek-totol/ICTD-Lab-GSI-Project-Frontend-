        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          >
            <div className="bg-white backdrop-blur-xl border border-emerald-100 rounded-3xl p-8 lg:p-10 shadow-xl relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-emerald-950 mb-2 relative z-10">
              ...
              <div className="space-y-6 relative z-10">
                {contactInfo.map((item, index) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-xl ${item.bg} flex items-center justify-center shrink-0 group-hover/item:scale-110 transition-transform duration-300`}
                    >
                      <item.icon className={`text-xl ${item.color}`} />
                    </div>
                    <div>
                      <h4 className="text-emerald-800 font-semibold text-sm uppercase tracking-wide opacity-80 mb-1">
                        {item.title}
                      </h4>
                      <p className="text-emerald-950 font-medium text-lg group-hover/item:text-emerald-600 transition-colors">
                        {item.value}
                      </p>
                    </div>
                  </a>
                ...
                <div className="flex gap-4">
                  {[FaFacebookF, FaTwitter, FaLinkedinIn].map((Icon, i) => (
                    <a
                      key={i}
                      href="#"
                      className="w-10 h-10 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600 hover:bg-emerald-500 hover:text-white transition-all duration-300 hover:-translate-y-1 border border-emerald-100"
                    >
                      <Icon />
                    </a>
                  ))}
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-emerald-700 ml-1">
