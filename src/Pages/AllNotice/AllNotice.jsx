    ...
    <section className="min-h-screen font-sans relative overflow-hidden bg-white mt-15">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-emerald-700 max-w-2xl mx-auto">{t('notice_subtitle')}</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-4 text-sm">
          <span className="text-emerald-700">
            {t('notice_showing')} {filtered.length ? start + 1 : 0} {t('notice_to')}{' '}
            {Math.min(start + entries, filtered.length)} {t('notice_of')} {filtered.length}{' '}
            {t('notice_entries')}
          </span>
