...
const Vendor = () => {
  ...
  const fallbackVendors = useMemo(
    () => [
      {
        id: 1,
        name: t('vendor_1_name'),
        address: t('vendor_1_address'),
        phone: '01711-588054',
        serial: 1,
        isActive: true,
      },
      {
        id: 2,
        name: t('vendor_2_name'),
        address: t('vendor_2_address'),
        phone: '01713-397560',
        serial: 2,
        isActive: true,
      },
      {
        id: 3,
        name: t('vendor_3_name'),
        address: t('vendor_3_address'),
        phone: '01712-445566',
        serial: 3,
        isActive: true,
      },
      {
        id: 4,
        name: t('vendor_4_name'),
        address: t('vendor_4_address'),
        phone: '01715-998877',
        serial: 4,
        isActive: true,
      },
      {
        id: 5,
        name: t('vendor_5_name'),
        address: t('vendor_5_address'),
        phone: '01718-223344',
        serial: 5,
        isActive: true,
      },
      {
        id: 6,
        name: t('vendor_6_name'),
        address: t('vendor_6_address'),
        phone: '01719-667788',
        serial: 6,
        isActive: true,
      },
    ...
    <section className="py-12 bg-emerald-50" id="vendor">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-lg text-emerald-700 mt-6 max-w-2xl mx-auto">{t('vendor_subtitle')}</p>
        </div>
          ...
          {vendors.map((vendor) => (
            ...
            >
              ...
              <div className="flex items-start gap-3 mb-4 text-emerald-600">
                ...
                <p className="text-sm leading-relaxed">{vendor.address}</p>
              </div>

              {/* Phone */}
              <div className="flex items-center gap-3 text-emerald-800 font-medium">
                <FaPhoneAlt className="text-emerald-500" />
                <span className="text-sm tracking-wide">{vendor.phone}</span>
              </div>
